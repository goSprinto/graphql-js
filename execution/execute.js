...
function completeValue(exeContext, returnType, fieldNodes, info, path, result) {
  ...
  if ((0, _definition.isListType)(returnType)) {
    if ((0, _definition.isListType)(returnType)) {
      var _exeContext$operation;

      return ((_exeContext$operation = exeContext.operation.name) === null ||
      _exeContext$operation === void 0
        ? void 0
        : _exeContext$operation.value) === 'IntrospectionQuery'
        ? completeListValue(
            exeContext,
            returnType,
            fieldNodes,
...
async function completeListValueChunked(
  ...
  for (const [index, item] of Array.from(result).entries()) {
    ...
    if (is20thElement && deltaFromStartTime > MAX_EVENTLOOP_BLOCK_TIME_IN_MS) {
      var _exeContext$operation2, _exeContext$operation3, _info$fieldName;

      console.warn(
        'GraphQLExecutor::EventLoopBlock - Exceeded max execution time per cycle',
        {
          operationName:
            (_exeContext$operation2 =
              (_exeContext$operation3 = exeContext.operation.name) === null ||
              _exeContext$operation3 === void 0
                ? void 0
                : _exeContext$operation3.value) !== null &&
            _exeContext$operation2 !== void 0
              ? _exeContext$operation2
              : 'Unknown',
          resolverName:
            (_info$fieldName = info.fieldName) !== null &&
            _info$fieldName !== void 0
              ? _info$fieldName
              : 'Unknown',
        },
      );
